                    ...
                    <div class="card-group">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <h1 class="card-title mb-3">Line 1</h1>
                                ...
                                <div class="btn-group btn-group-lg" role="group" aria-label="Basic outlined example">
                                    <button type="button" class="btn btn-success w-100px">Win</button>
                                    <button type="button" class="btn btn-danger w-100px">Lose</button>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            {{--<img src="..." class="card-img-top" alt="">--}}
                            <div class="card-body text-center">
                                <h1 class="card-title mb-3">Line 2</h1>
                        ...
                        <div class="card">
                            {{--<img src="..." class="card-img-top" alt="">--}}
                            <div class="card-body text-center">
                                <h1 class="card-title mb-3">Line 3</h1>
