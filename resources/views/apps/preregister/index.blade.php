                ...
                @foreach($registers as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('apps.preregister.pre-register.show', $item) }}" class="btn btn-sm btn-info btn-sm my-n1"><i class="fas fa-eye"></i></a>
                            @endcan
                            @can('pre-register-edit')
                            <a href="{{ route('apps.preregister.pre-register.edit', $item) }}" class="btn btn-sm btn-primary btn-sm my-n1"><i class="fas fa-pencil-alt"></i></a>
                            @endcan
                            @can('pre-register-delete')
                            <a href="{{ route('apps.preregister.pre-register.destroy', $item->id) }}" class="btn btn-sm btn-danger btn-sm my-n1" data-confirm-delete="true"><i class="fas fa-trash-alt"></i></a>
                            @endcan
                        </td>
                    </tr>
                @endforeach
