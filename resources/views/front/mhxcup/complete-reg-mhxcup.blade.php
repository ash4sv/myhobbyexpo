            ...
            <td colspan="2">
                <table>
                    <tr>
                        ...
                        <td>
                            Invoice #: {{ $pdfData['uniq'] }}<br />
                            Created: {{ date('d-m-Y', strtotime($pdfData['create_date'])) }}<br />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td colspan="2">
                <table>
                    <tr>
                        ...
                        <td>
                            {{ $pdfData['full_name'] }}<br />
                            {{ $pdfData['identification_card_number'] }}<br />
                            {{ $pdfData['group'] }}<br />
                            {{ $pdfData['phone_number'] }}<br>
                            {{ $pdfData['email'] }}<br>
                        </td>
                    </tr>
                </table>
